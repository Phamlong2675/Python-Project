        ...
        with self.topic_column:
            ...
            with ui.row().style('justify-content: center; margin: 10px 0;gap: 10px; flex-wrap: wrap;'):
                    if self.selected_difficulty == 'Easy':
                        ui.button('Movies', on_click=lambda: self.set_topic('Movies - Easy')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md') 
                        ui.button('Snowfall', on_click=lambda: self.set_topic('Snowfall - Easy')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Grant', on_click=lambda: self.set_topic('Grant - Easy')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Weather', on_click=lambda: self.set_topic('Weather - Easy')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')  
                        ui.button('Daily', on_click=lambda: self.set_topic('Daily - Easy')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                    elif self.selected_difficulty == 'Hard':
                        ui.button('Excursion', on_click=lambda: self.set_topic('Excursion - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Healthy', on_click=lambda: self.set_topic('Healthy - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Restaurant', on_click=lambda: self.set_topic('Restaurant - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Painting', on_click=lambda: self.set_topic('Painting - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
                        ui.button('Project', on_click=lambda: self.set_topic('Project - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')        
