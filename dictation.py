        ...
        with self.topic_column:
            ...
            with ui.row().style('justify-content: center; margin: 10px 0;gap: 10px; flex-wrap: wrap;'):
                    if self.selected_difficulty == 'Easy':
                        ...
                        ui.button('Topic 2', on_click=lambda: self.set_topic('Topic 2 - Hard')).props('rounded').classes('w-full bg-indigo hover:bg-indigo text-white font-semibold py-2 rounded-lg shadow-md')
